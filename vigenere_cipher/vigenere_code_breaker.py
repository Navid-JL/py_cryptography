...
import pyperclip
from frequency_analysis.frequency import englishFreqMatchScore
...
def attemptHackWithKeyLength(ciphertext, mostLikelyKeyLength):
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        for possibleKey in LETTERS:
            decryptedText = VigenereCipher.decrypt(
                nthLetters, possibleKey)
            keyAndFreqMatchTuple = (
                possibleKey, englishFreqMatchScore(decryptedText))
